<%@ Page Title="" Language="C#" MasterPageFile="~/SiteClienteInd.Master" AutoEventWireup="true" CodeBehind="pageRetiro.aspx.cs" Inherits="ejemplobienHecho.pageRetiro" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1 style="text-align: center">Retiro</h1>
    </section>
...
&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style30">
                                        <asp:TextBox ID="txtFecha" runat="server" Width="294px" TextMode="Date"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="auto-style31">Numero de Cuenta</td>
