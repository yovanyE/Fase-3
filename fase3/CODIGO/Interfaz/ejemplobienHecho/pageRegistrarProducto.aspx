<%@ Page Title="" Language="C#" MasterPageFile="~/SiteGerencial.Master" AutoEventWireup="true" CodeBehind="pageRegistrarProducto.aspx.cs" Inherits="ejemplobienHecho.pageRegistrarProducto" %>
...
&nbsp;
                                ...
                                <tr>
                                    <td class="auto-style29">Proveedor</td>
                                    <td class="auto-style30">
                                        <asp:TextBox ID="txtProveedor" runat="server" Width="294px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
