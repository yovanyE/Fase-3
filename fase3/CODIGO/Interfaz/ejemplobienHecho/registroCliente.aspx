<%@ Page Title="" Language="C#" MasterPageFile="~/SitePrincipal.Master" AutoEventWireup="true" CodeBehind="registroCliente.aspx.cs" Inherits="ejemplobienHecho.registroCliente" %>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtNroDocumento" runat="server" Text="" CssClass="form-control" Width="284px"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>NOMBRES</label>
                        </div>
                        <div class="form-group">
                            <asp:TextBox ID="txtNombres" runat="server" Text="" CssClass="form-control" Width="281px"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            Fecha de Nacimiento</div>
                        <div class="form-group">
                            <asp:TextBox ID="txtApPaterno" runat="server" Text="" CssClass="form-control" Width="281px"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            &nbsp;Sueldo</div>
                        <div class="form-group">
                            <asp:TextBox ID="txtApMaterno" runat="server" Text="" CssClass="form-control" Width="281px"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
