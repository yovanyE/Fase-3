<%@ Page Title="" Language="C#" MasterPageFile="~/SiteEjemplo.Master" AutoEventWireup="true" CodeBehind="pageRegistroexample.aspx.cs" Inherits="ejemplobienHecho.pageRegistroexample" %>
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            <label>DOCUMENTO DE IDENTIDAD</label></div>
                        <div class="form-group">
                        </div>
                        <div class="form-group">
                            <label>NOMBRES</label>
                        ...
                        <div class="form-group">
                            &nbsp;contraseña</div>
                        <div class="form-group">
                            <asp:TextBox ID="txtPassword" runat="server" Text="" CssClass="form-control" Width="281px"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
