...
public class ReportePatrocinadorSolicitado {
public static void generarReportePatrocinador(String nombreReporte, Map parametros, String titulo){
        InputStream reporte=GenerarReportePrestamo.class.getResourceAsStream("reportePatrocinadorSolicitado.jasper");
